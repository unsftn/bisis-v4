...
import com.gint.app.bisis4.client.circ.commands.reports.MmbrTypeReportCommand;
...
public class MmbrType {
	...
	public static JasperPrint setPrint(Date date, Object branch)
		...
		JRXmlDataSource ds;
		try {
			MmbrTypeReportCommand mmbrType = new MmbrTypeReportCommand(date,branch);
			mmbrType = (MmbrTypeReportCommand)Cirkulacija.getApp().getService().executeCommand(mmbrType);
			Document dom = setXML(mmbrType.getList());
			ds = new JRXmlDataSource(dom, "/report/row");
			JasperPrint jp = JasperFillManager
					.fillReport(
							MmbrType.class
									.getResource(
											"/com/gint/app/bisis4/client/circ/jaspers/vrsta.jasper")
