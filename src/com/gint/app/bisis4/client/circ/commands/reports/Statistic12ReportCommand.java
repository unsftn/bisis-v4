...
public class Statistic12ReportCommand extends HibernateCommand {
	
	/**
	 * broj usluga razduzenja
	 */
	...
	public Statistic12ReportCommand(Date start, Date end, Object location){
		this.start = start;
		this.end = end;
	...
	public void execute() {
		try{
		 ...
		 if (!location.equals(" ")) {
		  ...
		  tx.commit();
		  log.info("Statistic12 report");
		}catch (Exception e){
			log.error("Statistic12 report failed");
			log.error(e);
		}
	}
