...
public class StanjeFondaSerijske extends Report {
	...
	public class Item implements Comparable {
		...
		public String toString() {
			...
			buf.append("</sigla>\n");
			buf.append("<ogranak>");
			buf.append(HoldingsDataCodersJdbc.getValue(
					HoldingsDataCodersJdbc.ODELJENJE_CODER, sigla));
			buf.append("</ogranak>\n    <primerci>");
			buf.append(primerci);
			buf.append("</primerci>\n  </item>");
			return buf.toString();
	...
	private static Log log = LogFactory.getLog(StanjeFondaSerijske.class);
