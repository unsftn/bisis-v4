...
public class InventarnaKnjigaOgranci extends Report{
	public class Item implements Comparable {
	    ...
	    public String toString() {
	      ...
	      buf.append("</opis>\n    <povez>");
	      buf.append(nvl(HoldingsDataCodersJdbc.getValue(HoldingsDataCodersJdbc.POVEZ_CODER, nvl(povez))));
	      buf.append("</povez>\n    <dim>");
  ...
  public void handleRecord(Record rec) {
    ...
    for (Primerak p : rec.getPrimerci()) {
      ...
      String nabavka= HoldingsDataCodersJdbc.getValue(HoldingsDataCodersJdbc.NACINNABAVKE_CODER, vrnab);
      ...
      if(part==null){
    	if (type.equals("online")){
         ...
         key = settings.getParam("file") +"("+i.ogr+")"+ getFilenameSuffix(p.getDatumInventarisanja());
    	}
        ...
        key = settings.getParam("file") +"("+i.ogr+")"+"-"+ReportsUtils.addZeroes(String.valueOf(odBr))+"_do_"+ReportsUtils.addZeroes(String.valueOf(doBr));
      }
      getList(key).add(i);
