package com.gint.app.bisis4.reports.szpb;
	  ...
	  public class Item implements Comparable  {
		  ...
		  int primerci;	    
		    ...
		    public String toString() {
		      ...
		      buf.append("</sigla>\n");
		      buf.append("<ogranak>");
		      buf.append(HoldingsDataCodersJdbc.getValue(HoldingsDataCodersJdbc.ODELJENJE_CODER, sigla)==null ?  "nepoznato":HoldingsDataCodersJdbc.getValue(HoldingsDataCodersJdbc.ODELJENJE_CODER, sigla));
		      buf.append("</ogranak>\n    <primerci>");
		      buf.append(primerci);
		      buf.append("</primerci>\n  </item>");
		      return buf.toString();
