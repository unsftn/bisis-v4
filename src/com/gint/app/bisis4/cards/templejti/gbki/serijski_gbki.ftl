...
><#macro napomene430i440
    ...
    ><#if recUtil.getSubfieldContent("430a")!=""
	 ><#assign nap430i440 = nap430i440 + "\x0408\x0435 \x043D\x0430\x0441\x0442\x0430\x0432\x0430\x043A:&nbsp;"+recUtil.getSubfieldContent("430a")
	></#if
	><#if recUtil.getSubfieldContent("440a")!=""
	 ><#assign nap430i440 = nap430i440 + "\x041D\x0430\x0441\x0442\x0430\x0432\x0459\x0430 \x0441\x0435 \x043A\x0430\x043E:&nbsp;"+recUtil.getSubfieldContent("440a")
	></#if	 
></#macro
>
