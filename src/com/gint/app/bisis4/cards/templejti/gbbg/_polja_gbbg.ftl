     ...
     ><#if (allSF?index_of("d")!=-1 || allSF?index_of("@")!=-1) &&  subField.name="d"
              ...
              ><#list subField.ssf as subSubField    
                 ...
                 ><#if subSubField.name="i"                      
                      ><#assign vali=subSubField.content                 
                 ></#if
                 ><#if subSubField.name="f"                         
                      ><#assign valf=subSubField.content                 
                 ></#if
                 ><#if subSubField.name="n"                      
                      ><#assign valn=subSubField.content                 
                 ></#if
                 ><#assign val=vali
                 ><#if vali!=""
                    ><#assign val=val+"&nbsp;"
...
><#list fieldSec.sf as subField
   ><#if subField.content="700" || subField.content="701" || subField.content="702" ||
      ...
      ><#else
         ><#assign pos=pos+1
      ></#if
   ><#elseif subField.content="200" ||subField.content="215"
       ><#assign autor=""
       ><#if (brA>0)
            ><#assign val=""
            ><@getFieldAuthor fieldSec/><#--  trazi autora broj pos
      ...
      ></#if
      ><#if subField.content="215" && past200
           ><#assign past200=false
           ><#assign val=""
           ><#assign allSF="a" 
           ><#assign field=subField.secField
