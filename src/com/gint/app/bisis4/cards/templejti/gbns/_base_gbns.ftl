...
<#-- februar 2008. bojana iskomentarisala  -->
><#macro signatura
 ><#assign sign=""
 ><#assign old=""
 ><#if primerci?exists               
...
><#macro odrediBrojSigli primerak
 ><#if primerak.status="9"
   ...
   ><#elseif sigla?starts_with("33")
      ><#assign s33R=s33R+1 
  ><#elseif sigla?starts_with("39")
     ><#assign s39R=s39R+1
   ><#elseif sigla?starts_with("40")
    ><#assign s40R=s40R+1
    ><#elseif sigla?starts_with("43")
     ><#assign s43R=s43R+1      
   ><#else 
      ><#assign s34R=s34R+1 
   ></#if   
 ><#else
   ...
   ><#elseif sigla?starts_with("33")
    ...
    ><#elseif sigla?starts_with("39")
      ...
      ><#if primerak.status!="" || primerak.odeljenje!=""
         ><#if primerak.status=""
           ><#assign i39="("+primerak.odeljenje+")" 
         ><#elseif primerak.odeljenje=""
           ><#assign i39="("+primerak.status+")" 
         ><#else
           ><#assign i39="("+primerak.status+"&nbsp;/&nbsp;"+primerak.odeljenje+")" 
         ></#if
      ></#if  
    ><#elseif sigla?starts_with("40")
      ><#assign s40=s40+1
      ><#if primerak.status!="" || primerak.odeljenje!=""
         ><#if primerak.status=""
           ><#assign i40="("+primerak.odeljenje+")" 
         ><#elseif primerak.odeljenje=""
           ><#assign i40="("+primerak.status+")" 
         ><#else
           ><#assign i40="("+primerak.status+"&nbsp;/&nbsp;"+primerak.odeljenje+")" 
         ></#if
      ></#if    
    ><#elseif sigla?starts_with("43")
      ><#assign s43=s43+1
      ><#if primerak.status!="" || primerak.odeljenje!=""
         ><#if primerak.status=""
           ><#assign i43="("+primerak.odeljenje+")" 
         ><#elseif primerak.odeljenje=""
           ><#assign i43="("+primerak.status+")" 
         ><#else
           ><#assign i43="("+primerak.status+"&nbsp;/&nbsp;"+primerak.odeljenje+")" 
         ></#if
      ></#if            
   ><#else 
      ><#assign s34=s34+1
