...
public class DropDownButton extends Box {
  ...
  public static void main(String[] args) {
    ...
    DropDownButton btn = new DropDownButton(
        new javax.swing.ImageIcon(DropDownButton.class.getResource(
            "/com/gint/app/bisis4/client/images/save.gif"))); 
    
    // napunimo stavke menija
    btn.getMenu().add(new JMenuItem("stavka 1"));
    btn.getMenu().add(new JMenuItem("stavka 2"));
    btn.getMenu().add(new JMenuItem("stavka 3"));
    
    // ako hocemo da klik na dugme pokrece prvu stavku menija
    btn.setRunFirstMenuOption(true);
    
    // oba dela dugmeta se mogu nezavisno enable/disable
    btn.setEnabled(true);
    btn.setDropDownEnabled(true);
