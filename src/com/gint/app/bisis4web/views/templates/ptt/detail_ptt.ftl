...
<#assign url = data.getSubfieldContent("856u")!>

<#assign invSig = utils.getInvSigList() !>
...
<#if url!="">
	<tr>
	<td valign=top width="18%"><i>${labels.url}:</i></td>
...
<#if invSig??>
	<tr>
	<td valign=top width="10%"><i>${labels.inventar}:<i></td>
	<td></td>
	</tr>
	<tr>
	...
	<table class="displayinnertable">
	<#list invSig as item>
	<tr>
	<td class="displayinnercell">Inventarni broj: ${item[0]}</td>
	<td class="displayinnercell">Signatura: ${item[1]}</td>
	</tr>
	</#list>
	</table>
	<br><br>
