...
<#assign primerci = utils.getRaspodela()>
...
<#if primerci??>
	<tr>
	<td valign=top width="18%"><i>${labels.dostupnost}:<i></td>
	<td></td>
	</tr>
	<tr>
	...
	<#list primerci as item>
	<tr>
	<td class="displayinnercell">${item[0]}</td>
	<td class="displayinnercell">dostupno ${item[1]}, slobodnih ${item[2]}</td>
	</tr>
	</#list>
	</table>
	<br><br>
